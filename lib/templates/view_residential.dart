...
class view_residetial extends StatefulWidget {
  ...
  final String garden2;
  final String carage2;
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          SizedBox(width: other_templates.width(context)/20,),
                          Icon( widget.garden2=="true" ?  Icons.check:Icons.close,),
                        ],
                      ),
                      ...
                      Row(
                        children: [
                          ...
                          SizedBox(width: other_templates.width(context)/20,),
                          Icon( widget.carage2 =="true" ?  Icons.check:Icons.close,),
                        ],
                      ),
                    ],
                  ),
