import 'package:diary/6_dashboard/add_property/preview_building.dart';
...
class _form_buildingState extends State<form_building> {
  ...
  /// main var
  String _building_type="مبنى سكني";
      ...
      appBar: AppBar(
        ...
        actions: [
          Padding(
              ...
              child: Text("اضافة عقار - مبنى",style: TextStyle(fontSize: 20.sp),))
        ],
      ),
        ...
        SingleChildScrollView(
          ...
          Container(
                    ...
                    children: [
                      GestureDetector(
                        child: other_templates.selsection(
                            8.h,
                            37.w,
                            23.sp, "تجاري", _b_commercial),
                        onTap: (){
                          setState(() {

                            _building_type="مبنى تجاري";
                      ...
                      GestureDetector(
                        child: other_templates.selsection(
                            8.h,
                            37.w,
                            21.sp, "سكني", _b_residential),
                        onTap: (){
                          setState(() {

                            _building_type="مبنى سكني";
                            _b_residential=true;
                            _b_commercial=false;
              ...
              // floor setter
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        rooms("عدد الطوابق", floors, Icon(Icons.layers, size: 30,)),
                  ...
                  Text(":اضافة صور للارض",style: TextStyle(fontSize: 23),),
